...
Drupal.behaviors.cosmeticFixes = function(context) {
  $('div.gold-sponsor-block, div.gold-sponsor-sidebar-block', context).each(function() {
    var height = $(this).height() + 11;
    $(this)
      .before('<div class="content-left" style="height: ' + height + 'px" />')
      .after('<div class="content-right" style="height: ' + height + 'px" />')
      .append('<div class="content-bottom"><div class="content-bottom-left" /><div class="content-bottom-right" /></div>')
  })
};
;
